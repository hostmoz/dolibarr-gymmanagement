...
/**
 *       \file       htdocs/gymmanagement/ajax/attendances.php
 *       \brief      File to return Ajax response on attendances list request
 */
...
dol_include_once('/gymmanagement/class/attendances.class.php');
...
$object = new Attendances($db);

// Security check
if (!$user->hasRight('gymmanagement', 'attendances', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax gymmanagement/ajax/attendances.php");

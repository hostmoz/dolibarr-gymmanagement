...
/**
 *       \file       htdocs/gymmanagement/ajax/classes.php
 *       \brief      File to return Ajax response on classes list request
 */
...
dol_include_once('/gymmanagement/class/classes.class.php');
...
$object = new Classes($db);

// Security check
if (!$user->hasRight('gymmanagement', 'classes', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax gymmanagement/ajax/classes.php");

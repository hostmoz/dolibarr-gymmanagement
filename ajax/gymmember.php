...
/**
 *       \file       htdocs/gymmanagement/ajax/gymmember.php
 *       \brief      File to return Ajax response on gymmember list request
 */
...
// Security check
if (!$user->hasRight('gymmanagement', 'gymmember', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax gymmanagement/ajax/gymmember.php");

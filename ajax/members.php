...
/**
 *       \file       htdocs/gymmanagement/ajax/members.php
 *       \brief      File to return Ajax response on members list request
 */
...
dol_include_once('/gymmanagement/class/members.class.php');
...
$object = new Members($db);

// Security check
if (!$user->hasRight('gymmanagement', 'members', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax gymmanagement/ajax/members.php");

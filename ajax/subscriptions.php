...
/**
 *       \file       htdocs/gymmanagement/ajax/subscriptions.php
 *       \brief      File to return Ajax response on subscriptions list request
 */
...
dol_include_once('/gymmanagement/class/subscriptions.class.php');
...
$object = new Subscriptions($db);

// Security check
if (!$user->hasRight('gymmanagement', 'subscriptions', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax gymmanagement/ajax/subscriptions.php");

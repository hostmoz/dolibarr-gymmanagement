...
/**
 *       \file       htdocs/gymmanagement/ajax/trainers.php
 *       \brief      File to return Ajax response on trainers list request
 */
...
dol_include_once('/gymmanagement/class/trainers.class.php');
...
$object = new Trainers($db);

// Security check
if (!$user->hasRight('gymmanagement', 'trainers', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax gymmanagement/ajax/trainers.php");

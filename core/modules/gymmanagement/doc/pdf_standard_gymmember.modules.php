...
/**
 *  \file       core/modules/gymmanagement/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_gymmember
 */
class pdf_standard_gymmember extends ModelePDFGymMember
{
	/**
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	GymMember	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('GYMMANAGEMENT_DRAFT_WATERMARK') && $object->status == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('GYMMANAGEMENT_DRAFT_WATERMARK')));
		}
